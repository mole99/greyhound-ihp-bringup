...
module simple_480p (
    ...
    // horizontal timings
    parameter HA_END = (800/4)-1;           // end of active pixels
    parameter HS_STA = HA_END + 40/4;   // sync starts after front porch
    parameter HS_END = HS_STA + 128/4;   // sync ends
    parameter LINE   = (1056/4)-1;           // last pixel on line (after back porch)

    // vertical timings
    parameter VA_END = 600-1;           // end of active pixels
